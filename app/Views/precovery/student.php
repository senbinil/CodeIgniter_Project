...
<div id="wrapper" style="height:100vh; padding-top:100px;">
    <div class="container   my-4 p-4  bg-white" id="step1">
        ...
        <div class="row">
            <label for="init" class="col-sm-3 col-form-label">Admission ID:</label>
            <div class="col-sm-3">
                <input type="text" class="form-control " id="admin_no" name="adminno"   autocomplete="off"    onkeypress="return onlyNumberKey(event)" placeholder="Enter you admission number" required>
            </div>
